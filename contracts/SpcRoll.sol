...
// SpcRoll helps your migrate your existing Uniswap LP tokens to SpcSwap LP ones
contract SpcRoll {
    ...
    function migrate(
        ...
        require(deadline >= block.timestamp, 'SpcSwap: EXPIRED');
    ...
    function removeLiquidity(
        ...
        require(amountA >= amountAMin, 'SpcRoll: INSUFFICIENT_A_AMOUNT');
        require(amountB >= amountBMin, 'SpcRoll: INSUFFICIENT_B_AMOUNT');
    }
